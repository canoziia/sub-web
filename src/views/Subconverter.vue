  ...
  data() {
    return {
      ...
      options: {
        ...
        backendOptions: [{ value: "https://sub.darknight.tech/sub?" }],
        remoteConfig: [
          {
            label: "ACL4SSR",
            options: [
              {
                label: "ACL4SSR_Online 默认版 Canoziia提供 (与Github同步)",
                value:
                  "https://raw.githubusercontent.com/canoziia/ACL4SSR/master/Clash/config/ACL4SSR_Online_Full_MultiMode.ini"
              },
              {
